...
\begin{center}
    ...
    \vspace{4mm}
     {Studij} %% Ispod su zakomentirani studiji pa odaberite odgovarajući studij
...
\begin{minipage}[t]{0.47\textwidth}
	{Mentor:} \normalsize\vspace{3mm} %% Ako je potrebno dodati komentora odkomentirajte redove 44, 45, 46. Pogledajte donje primjere za navođenje imena mentora/komentora:
